  ...
  return (
    <React.Fragment>
      ...
      <TInput
          ...
          label: 'contactSet',
          placeholder: 'Not chosen',
          value: model.contactSet,
          errors: modelErrors.contactSet,
          onChange: val => modelFormActions.changeField('contactSet', val),
          onValid: () => modelFormActions.resetFieldError('contactSet'),
          onInvalid: err => modelFormActions.setFieldError('contactSet', err),
          validate: {
            checkOnBlur: true,
            required: false,
          },
